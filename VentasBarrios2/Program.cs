...
namespace ex03_VentasBarrio
{
    public class Program
    {
        ...
        public static void IdentificaPromedioBarrio(float[] promedioBarrios, string[] nombresBarrios1, out float mejorPromedio, out string[] nombresBarrios2)
        {
            throw new NotImplementedException();
        }

        public static void TotalizaPedidosBarrios(int cantidadGalletas, string[] nombresBarrios, out float cantidadPedidos, out string nombrePedidosBarrio)
        {
            throw new NotImplementedException();
        }

        public static void IdentificaPromedioBarrio(float[] promedioBarrios, string[] nombresBarrios, out float mejorPromedio, out string nombreMejorBarrio)
        {
            throw new NotImplementedException();
        }
    }
